...
template class MITMSearch<Limited_count, uint64_t>;
template class MITMSearch<Limited_count, uint128_t>;
template class MITMSearch<Limited_count, uint256_t>;
template class MITMSearch<Limited_count, uint512_t>;
template class MITMSearch<Limited_count, uint1024_t>;
template class MITMSearch<Limited_count, mpz_class>;

template class MITMSearch<Unlimited_count, uint64_t>;
template class MITMSearch<Unlimited_count, uint128_t>;
template class MITMSearch<Unlimited_count, uint256_t>;
template class MITMSearch<Unlimited_count, uint512_t>;
template class MITMSearch<Unlimited_count, uint1024_t>;
template class MITMSearch<Unlimited_count, mpz_class>;
} // namespace fpc